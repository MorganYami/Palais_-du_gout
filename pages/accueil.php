...
<div class="uk-section">
    <div class="uk-container">
        <p>
            ...
            se limiter à ses amis? D'autres personnes pourraient apprécier ces découvertes, voir vouloir les reproduire eux-mêmes.
            Et quel meilleur outil que internet pour partager?
            <br/> C'est ainsi que l'idée du Palais du goût est née: un site pour que tout le monde puisse découvrir et partager
            des recettes de plats provenant du monde entier.
        </p>
    </div>
    <div class="uk-section">
        <div class="uk-container">
                    ...
                    <div class="uk-card uk-card-default uk-card-hover">
                        <div class="uk-card-media-top">
                            <a href="./recettes/Asie/Corée/fichesCorée/ficheBibimbap.php">
                                <img src="<?php echo $cheminImg; ?>i35694-bibimbap-assiette-coreenne-de-riz-legumes-et-viande-marinee.jpg" alt="">
                            </a>
                        </div>
                        <div class="uk-card-body">
            ...
            <article class="uk-comment">
                ...
                <div class="uk-comment-body">
                    <p id="com">
                        ...
                        et netus et malesuada fames ac turpis egestas. Pellentesque vehicula arcu quis quam molestie, sit
                        amet consequat velit accumsan. Donec nec dui nisi.
                    </p>
                </div>
