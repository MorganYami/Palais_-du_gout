...
<div class="uk-section">
	<div class="uk-container centre">
		...
		<div class="uk-panel">
			<img class="uk-align-center uk-margin-remove-adjacent" data-src="<?php echo $cheminImg; ?>onigiri.jpg"
			 width="305" alt="Des Onigiri" uk-img>
			<h4>Ingrédients: </h4>
			<p>
		...
		<ul class="uk-list uk-list-divider">
			...
			<li>2: Préparez tous les ingrédients sur la table : Nori sur une grande assiette qui va accueillir les Onigiri; saumon grillé
				et émietté; prune ecrasée; un bol d'eau ; riz dans un grand saladier; sel.</li>
			...
			<li>5: Recouvrez avec du riz d'une quantité égale et pressez-le avec l'autre main, de manière à former le sommet d'un triangle</li>
			<li>6: Retournez l'ensemble et continuez à faire les 2 autres sommets du triangle.</li>
			<li>7: Aplatissez les 2 faces et mettez la feuille de Nori au centre d'un coté du triangle afin d'entourer la boule.</li>
